...
from error_handler import (
    EnhancedLogger, safe_execute, validate_input, ValidationError,
    safe_file_write, safe_file_read, ErrorRecovery
)
from security_utils import (
    InputSanitizer, NetworkValidator, SecureHeaders, RateLimiter,
...
class TestIntegration:
    ...
    def test_config_validation_with_error_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            invalid_config = {
                "repos": {"BadRepo": "not-a-url"},
                "limits": {"parallel_jobs": -1}
            }
